...
#ifndef UFO_GROUNDGNSS_OBSGROUNDGNSSMETOFFICETLAD_INTERFACE_H_
#define UFO_GROUNDGNSS_OBSGROUNDGNSSMETOFFICETLAD_INTERFACE_H_
...
#endif  // UFO_GROUNDGNSS_OBSGROUNDGNSSMETOFFICETLAD_INTERFACE_H_

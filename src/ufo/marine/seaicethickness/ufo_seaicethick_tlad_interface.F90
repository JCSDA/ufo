...
subroutine ufo_seaicethick_simobs_tl_c(c_key_self, c_key_geovals, c_nobs, c_hofx) bind(c,name='ufo_seaicethick_simobs_tl_f90')
...
call ufo_seaicethick_simobs_tl(self, geovals, c_hofx)

end subroutine ufo_seaicethick_simobs_tl_c

! ------------------------------------------------------------------------------

subroutine ufo_seaicethick_simobs_ad_c(c_key_self, c_key_geovals, c_nobs, c_hofx) bind(c,name='ufo_seaicethick_simobs_ad_f90')
...
call ufo_seaicethick_simobs_ad(self, geovals, c_hofx)

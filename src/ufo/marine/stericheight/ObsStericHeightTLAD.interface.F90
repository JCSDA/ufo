...
call ufo_stericheight_tlad_registry%setup(c_key_self, self)
...
subroutine ufo_stericheight_tlad_settraj_c(c_key_self, c_key_geovals, c_obsspace) bind(c,name='ufo_stericheight_tlad_settraj_f90')
...
subroutine ufo_stericheight_simobs_tl_c(c_key_self, c_key_geovals, c_obsspace, c_nobs, c_hofx) bind(c,name='ufo_stericheight_simobs_tl_f90')
...
subroutine ufo_stericheight_simobs_ad_c(c_key_self, c_key_geovals, c_obsspace, c_nobs, c_hofx) bind(c,name='ufo_stericheight_simobs_ad_f90')

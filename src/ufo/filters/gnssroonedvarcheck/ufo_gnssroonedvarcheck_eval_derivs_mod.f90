...
SUBROUTINE Ops_GPSRO_eval_derivs (Nstate,  &   ! size ot state vector
                                  Nobs,    &   ! no of obs
                                  ...
                                  threshold, & ! At what threshold to ignore differences
...
! If absolute difference is greater than threshold, then set difference to 0

WHERE (ABS (dy(:)) > threshold)
...
END SUBROUTINE Ops_GPSRO_eval_derivs

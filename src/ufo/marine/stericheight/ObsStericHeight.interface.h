...
#ifndef UFO_MARINE_STERICHEIGHT_OBSSTERICHEIGHT_INTERFACE_H_
#define UFO_MARINE_STERICHEIGHT_OBSSTERICHEIGHT_INTERFACE_H_
...
#endif  // UFO_MARINE_STERICHEIGHT_OBSSTERICHEIGHT_INTERFACE_H_

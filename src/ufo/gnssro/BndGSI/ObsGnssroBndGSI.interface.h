...
#ifndef UFO_GNSSRO_BNDGSI_OBSGNSSROBNDGSI_INTERFACE_H_
#define UFO_GNSSRO_BNDGSI_OBSGNSSROBNDGSI_INTERFACE_H_
...
#endif  // UFO_GNSSRO_BNDGSI_OBSGNSSROBNDGSI_INTERFACE_H_

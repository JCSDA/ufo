...
module ufo_atmsfcinterp_tlad_mod_c
...
#define LISTED_TYPE ufo_atmsfcinterp_tlad

  !> Linked list interface - defines registry_t type
#include "../linkedList_i.f"

  !> Global registry
  type(registry_t) :: ufo_atmsfcinterp_tlad_registry
...
subroutine ufo_atmsfcinterp_tlad_delete_c(c_key_self) bind(c,name='ufo_atmsfcinterp_tlad_delete_f90')
implicit none
integer(c_int), intent(inout) :: c_key_self
...
end module ufo_atmsfcinterp_tlad_mod_c

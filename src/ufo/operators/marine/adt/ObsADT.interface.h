...
#ifndef UFO_OPERATORS_MARINE_ADT_OBSADT_INTERFACE_H_
#define UFO_OPERATORS_MARINE_ADT_OBSADT_INTERFACE_H_
...
#endif  // UFO_OPERATORS_MARINE_ADT_OBSADT_INTERFACE_H_

...
subroutine ufo_seaicefrac_simobs_tl_c(c_key_self, c_key_geovals, c_key_hofx) bind(c,name='ufo_seaicefrac_simobs_tl_f90')
...
call ufo_seaicefrac_simobs_tl(self, geovals, hofx)

end subroutine ufo_seaicefrac_simobs_tl_c

! ------------------------------------------------------------------------------

subroutine ufo_seaicefrac_simobs_ad_c(c_key_self, c_key_geovals, c_key_hofx) bind(c,name='ufo_seaicefrac_simobs_ad_f90')
...
call ufo_seaicefrac_simobs_ad(self, geovals, hofx)

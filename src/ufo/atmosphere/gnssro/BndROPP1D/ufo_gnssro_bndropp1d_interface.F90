...
call ufo_gnssro_BndROPP1D_registry%delete(c_key_self,self)
    
end subroutine ufo_gnssro_bndropp1d_delete_c
  
! ------------------------------------------------------------------------------

subroutine ufo_gnssro_bndropp1d_simobs_c(c_key_self, c_key_geovals, c_obsspace, c_nobs, c_hofx, c_bias) bind(c,name='ufo_gnssro_bndropp1d_simobs_f90')
...
subroutine ufo_gnssro_bndropp1d_locateobs_c(c_key_self, c_obsspace, c_t1, c_t2, c_locs) bind(c,name='ufo_gnssro_bndropp1d_locateobs_f90')
...
character(len=*), parameter :: myname_="ufo_gnssro_bndropp1d_locateobs_c"

call ufo_gnssro_BndROPP1D_registry%get(c_key_self, self)
call self%opr_locateobs(c_obsspace, c_t1, c_t2, c_locs)

end subroutine ufo_gnssro_bndropp1d_locateobs_c

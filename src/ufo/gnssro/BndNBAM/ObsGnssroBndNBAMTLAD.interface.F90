...
call ufo_gnssro_BndNBAM_tlad_registry%setup(c_key_self, self)
...
subroutine ufo_gnssro_bndnbam_tlad_settraj_c(c_key_self, c_key_geovals, c_obsspace) bind(c,name='ufo_gnssro_bndnbam_tlad_settraj_f90')
...
character(len=*), parameter :: myname_="ufo_gnssro_bndnbam_tlad_settraj_c"
...
subroutine ufo_gnssro_bndnbam_simobs_tl_c(c_key_self, c_key_geovals, c_obsspace, c_nobs, c_hofx) bind(c,name='ufo_gnssro_bndnbam_simobs_tl_f90')
...
character(len=*), parameter :: myname_="ufo_gnssro_bndnbam_simobs_tl_c"

call ufo_gnssro_BndNBAM_tlad_registry%get(c_key_self, self)
call self%opr_simobs_tl(c_key_geovals, c_obsspace, c_hofx)

end subroutine ufo_gnssro_bndnbam_simobs_tl_c

! ------------------------------------------------------------------------------

subroutine ufo_gnssro_bndnbam_simobs_ad_c(c_key_self, c_key_geovals, c_obsspace, c_nobs, c_hofx) bind(c,name='ufo_gnssro_bndnbam_simobs_ad_f90')
...
character(len=*), parameter :: myname_="ufo_gnssro_bndnbam_simobs_ad_c"

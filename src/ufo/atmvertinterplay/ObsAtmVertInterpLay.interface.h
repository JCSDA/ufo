...
#ifndef UFO_ATMVERTINTERPLAY_OBSATMVERTINTERPLAY_INTERFACE_H_
#define UFO_ATMVERTINTERPLAY_OBSATMVERTINTERPLAY_INTERFACE_H_
...
#endif  // UFO_ATMVERTINTERPLAY_OBSATMVERTINTERPLAY_INTERFACE_H_

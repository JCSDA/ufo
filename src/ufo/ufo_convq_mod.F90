...
!> Fortran module to handle convq observations

module ufo_convq_mod
...
#include "linkedList_i.f"
  ...
  !> Global registry
  type(registry_t) :: ufo_convq_registry
...
subroutine ufo_convq_setup_c(c_key_self, c_conf) bind(c,name='ufo_convq_setup_f90')
implicit none
...
end subroutine ufo_convq_setup_c
  
! ------------------------------------------------------------------------------
  
subroutine ufo_convq_delete_c(c_key_self) bind(c,name='ufo_convq_delete_f90')
implicit none
integer(c_int), intent(inout) :: c_key_self
...
end subroutine ufo_convq_delete_c
...
! ------------------------------------------------------------------------------
subroutine ufo_convq_eqv_c(c_key_geovals, c_key_hofx, c_bias) bind(c,name='ufo_convq_eqv_f90')
...
subroutine ufo_convq_inputs_c(c_key_self, c_key_vars) bind(c,name='ufo_convq_inputs_f90')
implicit none
...
end subroutine ufo_convq_inputs_c
  
  
end module ufo_convq_mod

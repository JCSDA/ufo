...
subroutine ufo_atmvertinterplay_tlad_setup_c(c_key_self, c_conf, csin, c_str_size) bind(c,name='ufo_atmvertinterplay_tlad_setup_f90')
implicit none
...
call ufo_atmvertinterplay_tlad_registry%remove(c_key_self)
...
subroutine ufo_atmvertinterplay_simobs_tl_c(c_key_self, c_key_geovals, c_obsspace, c_nobs, c_hofx) bind(c,name='ufo_atmvertinterplay_simobs_tl_f90')
...
subroutine ufo_atmvertinterplay_simobs_ad_c(c_key_self, c_key_geovals, c_obsspace, c_nobs, c_hofx) bind(c,name='ufo_atmvertinterplay_simobs_ad_f90')

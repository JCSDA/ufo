...
#ifndef UFO_AEROSOLS_AODMETOFFICE_OBSAODMETOFFICE_H_
#define UFO_AEROSOLS_AODMETOFFICE_OBSAODMETOFFICE_H_
...
#endif  // UFO_AEROSOLS_AODMETOFFICE_OBSAODMETOFFICE_H_

...
#ifndef UFO_ATMOSPHERE_RADIANCE_OBSRADIANCE_INTERFACE_H_
#define UFO_ATMOSPHERE_RADIANCE_OBSRADIANCE_INTERFACE_H_
...
#endif  // UFO_ATMOSPHERE_RADIANCE_OBSRADIANCE_INTERFACE_H_

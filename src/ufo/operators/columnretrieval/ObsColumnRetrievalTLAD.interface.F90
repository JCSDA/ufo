...
!> Fortran columnretrieval module for functions on the interface between C++ and Fortran
...
#define LISTED_TYPE ufo_columnretrieval_tlad

  !> Linked list interface - defines registry_t type
#include "oops/util/linkedList_i.f"

  !> Global registry
  type(registry_t) :: ufo_columnretrieval_tlad_registry
...
type(ufo_columnretrieval_tlad), pointer :: self
type(fckit_configuration) :: f_conf

call ufo_columnretrieval_tlad_registry%setup(c_key_self, self)
...
! type ufo_columnretrieval_tlad has allocatable data, but has a destructor marked final that
! should automatically deallocate (assuming compiler support...)
call ufo_columnretrieval_tlad_registry%remove(c_key_self)

end subroutine ufo_columnretrieval_tlad_delete_c
...
character(len=*), parameter :: myname_="ufo_columnretrieval_tlad_settraj_c"
call ufo_columnretrieval_tlad_registry%get(c_key_self, self)
call ufo_geovals_registry%get(c_key_geovals, geovals)
call self%settraj(geovals, c_obsspace)

end subroutine ufo_columnretrieval_tlad_settraj_c
...
character(len=*), parameter :: myname_="ufo_columnretrieval_simobs_tl_c"
...
end subroutine ufo_columnretrieval_simobs_tl_c
...
character(len=*), parameter :: myname_="ufo_columnretrieval_simobs_ad_c"
...
end subroutine ufo_columnretrieval_simobs_ad_c

! ------------------------------------------------------------------------------

end module ufo_columnretrieval_tlad_mod_c

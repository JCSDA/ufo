...
subroutine ufo_insitutemperature_tlad_setup_c(c_key_self, c_conf, c_obsvars, c_obsvarindices, &
    c_nobsvars, c_geovars) bind(c,name='ufo_insitutemperature_tlad_setup_f90')
  ...
  call ufo_insitutemperature_tlad_registry%setup(c_key_self, self)
...
subroutine ufo_insitutemperature_tlad_settraj_c(c_key_self, c_key_geovals, c_obsspace) &
    bind(c,name='ufo_insitutemperature_tlad_settraj_f90')
...
subroutine ufo_insitutemperature_simobs_tl_c(c_key_self, c_key_geovals, c_obsspace, c_nvars, c_nlocs, c_hofx) &
    bind(c,name='ufo_insitutemperature_simobs_tl_f90')
  integer(c_int), intent(in) :: c_key_self
  integer(c_int), intent(in) :: c_key_geovals
  type(c_ptr), value, intent(in) :: c_obsspace
...
subroutine ufo_insitutemperature_simobs_ad_c(c_key_self, c_key_geovals, c_obsspace, c_nvars, c_nlocs, c_hofx) &
    bind(c,name='ufo_insitutemperature_simobs_ad_f90')

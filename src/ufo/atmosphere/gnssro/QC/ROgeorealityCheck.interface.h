...
#ifndef UFO_ATMOSPHERE_GNSSRO_QC_ROGEOREALITYCHECK_INTERFACE_H_
#define UFO_ATMOSPHERE_GNSSRO_QC_ROGEOREALITYCHECK_INTERFACE_H_
...
#endif  // UFO_ATMOSPHERE_GNSSRO_QC_ROGEOREALITYCHECK_INTERFACE_H_

...
!> Fortran module for radarradialvelocity tl/ad observation operator
...
module ufo_radarradialvelocity_tlad_mod
 ...
 !       this type can hold information on trajectory, for radarradialvelocity
 type, public :: ufo_radarradialvelocity_tlad
 private
  integer :: nvars_in
  character(len=MAXVARLEN), public, allocatable :: varin(:)
 contains
  procedure :: setup  => ufo_radarradialvelocity_tlad_setup
  procedure :: settraj => ufo_radarradialvelocity_tlad_settraj
  procedure :: simobs_tl  => ufo_radarradialvelocity_simobs_tl
  procedure :: simobs_ad  => ufo_radarradialvelocity_simobs_ad
  final :: destructor
...
subroutine ufo_radarradialvelocity_tlad_setup(self, f_conf, vars)
implicit none
...
end subroutine ufo_radarradialvelocity_tlad_setup
...
subroutine ufo_radarradialvelocity_tlad_settraj(self, geovals, obss)
implicit none
class(ufo_radarradialvelocity_tlad), intent(inout) :: self
type(ufo_geovals),       intent(in)    :: geovals
type(c_ptr), value,      intent(in)    :: obss

end subroutine ufo_radarradialvelocity_tlad_settraj

! ------------------------------------------------------------------------------
! TODO: replace below function with your tl observation operator.
! Note: this can use information saved from trajectory in your ufo_radarradialvelocity_tlad type
! Input geovals parameter represents dx for tangent linear model
subroutine ufo_radarradialvelocity_simobs_tl(self, geovals, obss, nvars, nlocs, hofx)
implicit none
...
end subroutine ufo_radarradialvelocity_simobs_tl

! ------------------------------------------------------------------------------
! TODO: replace below function with your ad observation operator.
! Note: this can use information saved from trajectory in your ufo_radarradialvelocity_tlad type
subroutine ufo_radarradialvelocity_simobs_ad(self, geovals, obss, nvars, nlocs, hofx)
implicit none
class(ufo_radarradialvelocity_tlad), intent(in)    :: self
...
end subroutine ufo_radarradialvelocity_simobs_ad

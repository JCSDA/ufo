...
#define LISTED_TYPE ufo_gnssro_BndROPP2D_tlad

  !> Linked list interface - defines registry_t type
#include "oops/util/linkedList_i.f"

  !> Global registry
  type(registry_t) :: ufo_gnssro_BndROPP2D_tlad_registry
...
subroutine ufo_gnssro_bndropp2d_tlad_setup_c(c_key_self, c_conf) bind(c,name='ufo_gnssro_bndropp2d_tlad_setup_f90')
...
subroutine ufo_gnssro_bndropp2d_tlad_delete_c(c_key_self) bind(c,name='ufo_gnssro_bndropp2d_tlad_delete_f90')
implicit none
integer(c_int), intent(inout) :: c_key_self
    
type(ufo_gnssro_BndROPP2D_tlad), pointer :: self

call ufo_gnssro_BndROPP2D_tlad_registry%get(c_key_self, self)
call self%opr_delete()
call ufo_gnssro_BndROPP2D_tlad_registry%remove(c_key_self)
    
end subroutine ufo_gnssro_bndropp2d_tlad_delete_c
...
character(len=*), parameter :: myname_="ufo_gnssro_bndropp2d_tlad_settraj_c"

call ufo_gnssro_BndROPP2D_tlad_registry%get(c_key_self, self)
call self%opr_settraj(c_key_geovals, c_obsspace)

end subroutine ufo_gnssro_bndropp2d_tlad_settraj_c 
...
character(len=*), parameter :: myname_="ufo_gnssro_bndropp2d_simobs_tl_c"

call ufo_gnssro_BndROPP2D_tlad_registry%get(c_key_self, self)
call self%opr_simobs_tl(c_key_geovals, c_obsspace, c_hofx)

end subroutine ufo_gnssro_bndropp2d_simobs_tl_c
...
character(len=*), parameter :: myname_="ufo_gnssro_bndropp2d_simobs_ad_c"

call ufo_gnssro_BndROPP2D_tlad_registry%get(c_key_self, self)
call self%opr_simobs_ad(c_key_geovals, c_obsspace, c_hofx)

end subroutine ufo_gnssro_bndropp2d_simobs_ad_c

! ------------------------------------------------------------------------------
  
end module ufo_gnssro_bndropp2d_tlad_mod_c

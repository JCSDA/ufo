...
#include "../linkedList_i.f"
  ...
  !> Global registry
  type(registry_t) :: ufo_identity_tlad_registry
...
subroutine ufo_identity_tlad_setup_c(c_key_self, c_conf, c_varconf, csin, c_str_size) bind(c,name='ufo_identity_tlad_setup_f90')
use ufo_vars_mod
implicit none
...
call f_c_string_vector(self%vars, csin)
deallocate(vars)
...
end subroutine ufo_identity_tlad_delete_c

! ------------------------------------------------------------------------------

subroutine ufo_identity_tlad_settraj_c(c_key_self, c_key_geovals, c_obsspace) bind(c,name='ufo_identity_tlad_settraj_f90')
...
end subroutine ufo_identity_tlad_settraj_c
...
end module ufo_identity_tlad_mod_c

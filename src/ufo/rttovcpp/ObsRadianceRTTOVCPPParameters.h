...
#ifndef UFO_RTTOVCPP_OBSRADIANCERTTOVCPPPARAMETERS_H_
#define UFO_RTTOVCPP_OBSRADIANCERTTOVCPPPARAMETERS_H_
...
#endif  // UFO_RTTOVCPP_OBSRADIANCERTTOVCPPPARAMETERS_H_

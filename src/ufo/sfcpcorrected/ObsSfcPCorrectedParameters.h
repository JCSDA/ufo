...
#ifndef UFO_SFCPCORRECTED_OBSSFCPCORRECTEDPARAMETERS_H_
#define UFO_SFCPCORRECTED_OBSSFCPCORRECTEDPARAMETERS_H_
...
#endif  // UFO_SFCPCORRECTED_OBSSFCPCORRECTEDPARAMETERS_H_

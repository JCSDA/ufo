...
#ifndef UFO_ATMOSPHERE_CRTM_OBSAODCRTMTLAD_INTERFACE_H_
#define UFO_ATMOSPHERE_CRTM_OBSAODCRTMTLAD_INTERFACE_H_
...
// -----------------------------------------------------------------------------
  ...
  void ufo_aodcrtm_tlad_setup_f90(F90hop &, const eckit::Configuration * const *);
...
#endif  // UFO_ATMOSPHERE_CRTM_OBSAODCRTMTLAD_INTERFACE_H_

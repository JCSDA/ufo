...
#ifndef UFO_GNSSRO_REFNBAM_OBSGNSSROREF_INTERFACE_H_
#define UFO_GNSSRO_REFNBAM_OBSGNSSROREF_INTERFACE_H_
...
#endif  // UFO_GNSSRO_REFNBAM_OBSGNSSROREF_INTERFACE_H_

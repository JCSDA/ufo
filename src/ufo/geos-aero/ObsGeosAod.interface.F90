...
module ufo_geosaod_mod_c
  ...
  ! ------------------------------------------------------------------------------
#define LISTED_TYPE ufo_geosaod
...
subroutine ufo_geosaod_setup_c(c_key_self, c_conf, csin, csout, c_str_size) bind(c,name='ufo_geosaod_setup_f90')
implicit none
...
subroutine ufo_geosaod_delete_c(c_key_self) bind(c,name='ufo_geosaod_delete_f90')
implicit none
integer(c_int), intent(inout) :: c_key_self
...
call ufo_geosaod_registry%remove(c_key_self)

end subroutine ufo_geosaod_delete_c

! ------------------------------------------------------------------------------

subroutine ufo_geosaod_simobs_c(c_key_self, c_key_geovals, c_obsspace, c_nvars, c_nlocs, c_hofx) bind(c,name='ufo_geosaod_simobs_f90')
...
end subroutine ufo_geosaod_simobs_c

! ------------------------------------------------------------------------------

end module ufo_geosaod_mod_c

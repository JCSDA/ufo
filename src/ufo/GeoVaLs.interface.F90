...
subroutine ufo_geovals_fill_c(c_key, lvar, c_var, c_nloc, c_indx, c_nval, c_vals, c_levelsTopDown) &
...
call ufo_geovals_fill(geovals, varname, c_nloc, c_indx, c_nval, c_vals, c_levelsTopDown)

end subroutine ufo_geovals_fill_c

! ------------------------------------------------------------------------------

subroutine ufo_geovals_fillad_c(c_key, lvar, c_var, c_nloc, c_indx, c_nval, c_vals, c_levelsTopDown) &
...
call ufo_geovals_fillad(geovals, varname, c_nloc, c_indx, c_nval, c_vals, c_levelsTopDown)

...
#ifndef UFO_OPERATORS_AEROSOLS_MR_OBSAODGEOS_INTERFACE_H_
#define UFO_OPERATORS_AEROSOLS_MR_OBSAODGEOS_INTERFACE_H_
...
#endif  // UFO_OPERATORS_AEROSOLS_MR_OBSAODGEOS_INTERFACE_H_

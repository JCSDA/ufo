...
#define LISTED_TYPE ufo_aodluts_tlad

  !> Linked list interface - defines registry_t type
#include "oops/util/linkedList_i.f"

  !> Global registry
  type(registry_t) :: ufo_aodluts_tlad_registry
...
type(ufo_aodluts_tlad), pointer :: self
type(fckit_configuration) :: f_conf

call ufo_aodluts_tlad_registry%setup(c_key_self, self)
...
end subroutine ufo_aodluts_tlad_setup_c
...
call ufo_aodluts_tlad_registry%get(c_key_self, self)
call self%delete()
call ufo_aodluts_tlad_registry%remove(c_key_self)

end subroutine ufo_aodluts_tlad_delete_c
...
character(len=*), parameter :: myname_="ufo_aodluts_tlad_settraj_c"
...
end subroutine ufo_aodluts_tlad_settraj_c
...
character(len=*), parameter :: myname_="ufo_aodluts_simobs_tl_c"
...
end subroutine ufo_aodluts_simobs_tl_c
...
character(len=*), parameter :: myname_="ufo_aodluts_simobs_ad_c"
...
end subroutine ufo_aodluts_simobs_ad_c

! ------------------------------------------------------------------------------

end module ufo_aodluts_tlad_mod_c

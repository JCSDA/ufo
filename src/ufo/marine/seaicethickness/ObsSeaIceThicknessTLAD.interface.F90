...
#define LISTED_TYPE ufo_seaicethickness_tlad

  !> Linked list interface - defines registry_t type
#include "oops/util/linkedList_i.f"

  !> Global registry
  type(registry_t) :: ufo_seaicethickness_tlad_registry
...
subroutine ufo_seaicethickness_tlad_setup_c(c_key_self, c_conf) bind(c,name='ufo_seaicethickness_tlad_setup_f90')
implicit none
...
call ufo_seaicethickness_tlad_registry%remove(c_key_self)

end subroutine ufo_seaicethickness_tlad_delete_c
...
end subroutine ufo_seaicethickness_tlad_settraj_c

! ------------------------------------------------------------------------------

subroutine ufo_seaicethickness_simobs_tl_c(c_key_self, c_key_geovals, c_obsspace, c_nobs, c_hofx) bind(c,name='ufo_seaicethickness_simobs_tl_f90')
...
end subroutine ufo_seaicethickness_simobs_tl_c

! ------------------------------------------------------------------------------

subroutine ufo_seaicethickness_simobs_ad_c(c_key_self, c_key_geovals, c_obsspace, c_nobs, c_hofx) bind(c,name='ufo_seaicethickness_simobs_ad_f90')
...
end subroutine ufo_seaicethickness_simobs_ad_c

! ------------------------------------------------------------------------------


end module ufo_seaicethickness_tlad_mod_c

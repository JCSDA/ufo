...
// -----------------------------------------------------------------------------
  ...
  void ufo_gnssro_ref_f90(const F90hop &, const F90goms &, const F90odb &, const F90ovec &,
                          const F90obias &);
...
//  void ufo_gnssro_bendangleGSI_f90(const F90hop &, const F90goms &, const F90odb &,
//                                   const F90ovec &, const F90obias &);
//  void ufo_gnssro_bendangleGSI_tlad_settraj_f90(const F90hop &, const F90goms &, const F90odb &);
//  void ufo_gnssro_bendangleGSI_tlad_tl_f90(const F90hop &, const F90goms &, const F90odb &,
//                                           const F90ovec &);
//  void ufo_gnssro_bendangleGSI_tlad_ad_f90(const F90hop &, const F90goms &, const F90odb &,
//                                           const F90ovec &);
// -----------------------------------------------------------------------------

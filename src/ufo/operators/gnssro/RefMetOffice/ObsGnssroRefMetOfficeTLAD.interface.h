...
#ifndef UFO_OPERATORS_GNSSRO_REFMETOFFICE_OBSGNSSROREFMETOFFICETLAD_INTERFACE_H_
#define UFO_OPERATORS_GNSSRO_REFMETOFFICE_OBSGNSSROREFMETOFFICETLAD_INTERFACE_H_
...
// -----------------------------------------------------------------------------
  ...
  void ufo_gnssro_refmetoffice_tlad_settraj_f90(const F90hop &, const F90goms &,
                                             const ioda::ObsSpace &);
  void ufo_gnssro_refmetoffice_simobs_tl_f90(
          const F90hop &, const F90goms &, const ioda::ObsSpace &, const int &, double &);
  void ufo_gnssro_refmetoffice_simobs_ad_f90(
...
#endif  // UFO_OPERATORS_GNSSRO_REFMETOFFICE_OBSGNSSROREFMETOFFICETLAD_INTERFACE_H_

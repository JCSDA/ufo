! (C) Copyright 2007-2021 NOAA NWS NCEP EMC
...
!$$$ end documentation block
 ...
 ! GSI constants that are not in ufo_constants_mod
...
!$$$
 ...
 use ufo_constants_mod, only : pi, half, one, two
...
!$$$
 ...
 use ufo_constants_mod, only : rad2deg, one
...
!$$$
 ...
 use ufo_constants_mod, only : pi, rad2deg, zero, half, one, two

 implicit none

! Declare passed variables
 integer,         intent(in   ) :: fov, instr
...
!$$$
 ...
 use ufo_constants_mod, only  : one, zero, half, two, pi, deg2rad, rad2deg
...
! Declare passed variables
 integer,         intent(in   ) :: fov
 integer,         intent(in   ) :: instr, ichan
 logical        , intent(  out) :: valid

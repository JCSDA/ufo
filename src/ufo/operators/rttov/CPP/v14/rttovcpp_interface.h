...
#ifndef UFO_OPERATORS_RTTOV_CPP_V14_RTTOVCPP_INTERFACE_H_
#define UFO_OPERATORS_RTTOV_CPP_V14_RTTOVCPP_INTERFACE_H_
...
#endif  // UFO_OPERATORS_RTTOV_CPP_V14_RTTOVCPP_INTERFACE_H_

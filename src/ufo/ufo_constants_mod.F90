...
real(kind_real), parameter, public :: cp     = 1.004e3_kind_real ! heat capacity at constant pressure for air
real(kind_real), parameter, public :: cv     = 7.18e2_kind_real ! heat capacity at constant volume for air

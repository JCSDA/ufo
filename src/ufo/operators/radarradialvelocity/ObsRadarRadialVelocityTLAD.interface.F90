...
!> Fortran module to handle radarradialvelocity observations
...
! type ufo_radarradialvelocity_tlad has allocatable data, but has a destructor marked final that
! should automatically deallocate (assuming compiler support...)
call ufo_radarradialvelocity_tlad_registry%remove(c_key_self)
...
character(len=*), parameter :: myname_="ufo_radarradialvelocity_tlad_settraj_c"
...
character(len=*), parameter :: myname_="ufo_radarradialvelocity_simobs_tl_c"
...
character(len=*), parameter :: myname_="ufo_radarradialvelocity_simobs_ad_c"

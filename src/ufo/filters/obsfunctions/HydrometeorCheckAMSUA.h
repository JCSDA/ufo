...
#ifndef UFO_FILTERS_OBSFUNCTIONS_HYDROMETEORCHECKAMSUA_H_
#define UFO_FILTERS_OBSFUNCTIONS_HYDROMETEORCHECKAMSUA_H_
...
///
class HydrometeorCheckAMSUAParameters : public oops::Parameters {
  OOPS_CONCRETE_PARAMETERS(HydrometeorCheckAMSUAParameters, Parameters)
...
class HydrometeorCheckAMSUA : public ObsFunctionBase<float> {
 ...
 private:
  ...
  HydrometeorCheckAMSUAParameters options_;
};
...
#endif  // UFO_FILTERS_OBSFUNCTIONS_HYDROMETEORCHECKAMSUA_H_

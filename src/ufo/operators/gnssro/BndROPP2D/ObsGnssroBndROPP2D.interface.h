...
#ifndef UFO_OPERATORS_GNSSRO_BNDROPP2D_OBSGNSSROBNDROPP2D_INTERFACE_H_
#define UFO_OPERATORS_GNSSRO_BNDROPP2D_OBSGNSSROBNDROPP2D_INTERFACE_H_
...
// -----------------------------------------------------------------------------
  void ufo_gnssro_2d_locs_init_f90(const F90hop &, const ioda::ObsSpace &, const int &,
                                   float &, float &);
...
#endif  // UFO_OPERATORS_GNSSRO_BNDROPP2D_OBSGNSSROBNDROPP2D_INTERFACE_H_

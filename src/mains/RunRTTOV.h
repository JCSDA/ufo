...
#ifndef MAINS_RUNRTTOV_H_
#define MAINS_RUNRTTOV_H_
...
template <typename MODEL> class RunRTTOV : public oops::Application {
...
// -----------------------------------------------------------------------------
 private:
  std::string appname() const {
    return "oops::RunRTTOV<" + MODEL::name() + ">";
  }
// -----------------------------------------------------------------------------
};

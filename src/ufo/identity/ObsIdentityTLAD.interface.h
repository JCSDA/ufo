...
#ifndef UFO_IDENTITY_OBSIDENTITYTLAD_INTERFACE_H_
#define UFO_IDENTITY_OBSIDENTITYTLAD_INTERFACE_H_
...
// -----------------------------------------------------------------------------
  ...
  void ufo_identity_tlad_setup_f90(F90hop &, const eckit::Configuration &,
  ...
  void ufo_identity_simobs_tl_f90(const F90hop &, const F90goms &, const ioda::ObsSpace &,
                                  const int &nvars, const int &nlocs, double &hofx);

...
// -----------------------------------------------------------------------------
  ...
  void ufo_gnssro_ref_simobs_tl_f90(const F90hop &, const F90goms &, const F90odb &, const F90ovec &);
  void ufo_gnssro_ref_simobs_ad_f90(const F90hop &, const F90goms &, const F90odb &, const F90ovec &);
...
// -----------------------------------------------------------------------------
  ...
  void ufo_gnssro_bndGSI_simobs_f90(const F90hop &, const F90goms &, const F90odb &, const F90ovec &,
                          const F90obias &);
  ...
  void ufo_gnssro_bndGSI_simobs_tl_f90(const F90hop &, const F90goms &, const F90odb &, const F90ovec &);
  void ufo_gnssro_bndGSI_simobs_ad_f90(const F90hop &, const F90goms &, const F90odb &, const F90ovec &);

...
subroutine ufo_marinevertinterp_setup_c(c_key_self, c_conf, c_obsvars, c_obsvarindices, &
                                        c_nobsvars, c_geovars) bind(c,name='ufo_marinevertinterp_setup_f90')
...
subroutine ufo_marinevertinterp_simobs_c(c_key_self, c_key_geovals, c_obsspace, c_nvars, &
                                        c_nlocs, c_hofx) &
                                        bind(c,name='ufo_marinevertinterp_simobs_f90')

...
subroutine ufo_atmvertinterplay_tlad_setup_c(c_key_self, c_conf, c_varconf, c_varlist) bind(c,name='ufo_atmvertinterplay_tlad_setup_f90')
use ufo_vars_mod
implicit none
...
subroutine ufo_atmvertinterplay_simobs_tl_c(c_key_self, c_key_geovals, c_obsspace, c_nvars, c_nlocs, c_hofx) bind(c,name='ufo_atmvertinterplay_simobs_tl_f90')
...
subroutine ufo_atmvertinterplay_simobs_ad_c(c_key_self, c_key_geovals, c_obsspace, c_nvars, c_nlocs, c_hofx) bind(c,name='ufo_atmvertinterplay_simobs_ad_f90')

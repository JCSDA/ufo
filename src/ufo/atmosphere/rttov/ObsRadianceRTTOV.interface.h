...
#ifndef UFO_ATMOSPHERE_RTTOV_OBSRADIANCERTTOV_INTERFACE_H_
#define UFO_ATMOSPHERE_RTTOV_OBSRADIANCERTTOV_INTERFACE_H_
...
#endif  // UFO_ATMOSPHERE_RTTOV_OBSRADIANCERTTOV_INTERFACE_H_

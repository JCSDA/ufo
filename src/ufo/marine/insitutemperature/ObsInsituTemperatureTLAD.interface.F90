...
subroutine ufo_insitutemperature_simobs_tl_c(c_key_self, c_key_geovals, c_obsspace, c_nobs, c_hofx) bind(c,name='ufo_insitutemperature_simobs_tl_f90')
...
subroutine ufo_insitutemperature_simobs_ad_c(c_key_self, c_key_geovals, c_obsspace, c_nobs, c_hofx) bind(c,name='ufo_insitutemperature_simobs_ad_f90')

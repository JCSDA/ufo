...
subroutine ufo_seaicefrac_simobs_tl_c(c_key_self, c_key_geovals, c_nobs, c_hofx) bind(c,name='ufo_seaicefrac_simobs_tl_f90')
...
character(len=*), parameter :: myname_="ufo_seaicefrac_simobs_tl_c"

call ufo_seaicefrac_tlad_registry%get(c_key_self, self)
call ufo_geovals_registry%get(c_key_geovals,geovals)

call ufo_seaicefrac_simobs_tl(self, geovals, c_hofx)

end subroutine ufo_seaicefrac_simobs_tl_c

! ------------------------------------------------------------------------------

subroutine ufo_seaicefrac_simobs_ad_c(c_key_self, c_key_geovals, c_nobs, c_hofx) bind(c,name='ufo_seaicefrac_simobs_ad_f90')
...
character(len=*), parameter :: myname_="ufo_seaicefrac_simobs_ad_c"

call ufo_seaicefrac_tlad_registry%get(c_key_self, self)
call ufo_geovals_registry%get(c_key_geovals,geovals)

call ufo_seaicefrac_simobs_ad(self, geovals, c_hofx)

end subroutine ufo_seaicefrac_simobs_ad_c

...
#ifndef UFO_MARINE_COOLSKIN_OBSCOOLSKINPARAMETERS_H_
#define UFO_MARINE_COOLSKIN_OBSCOOLSKINPARAMETERS_H_
...
#endif  // UFO_MARINE_COOLSKIN_OBSCOOLSKINPARAMETERS_H_

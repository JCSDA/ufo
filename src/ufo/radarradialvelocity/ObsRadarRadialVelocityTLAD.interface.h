...
#ifndef UFO_RADARRADIALVELOCITY_OBSRADARRADIALVELOCITYTLAD_INTERFACE_H_
#define UFO_RADARRADIALVELOCITY_OBSRADARRADIALVELOCITYTLAD_INTERFACE_H_
...
// -----------------------------------------------------------------------------
  ...
  void ufo_radarradialvelocity_tlad_setup_f90(F90hop &, const eckit::Configuration * const *,
...
#endif  // UFO_RADARRADIALVELOCITY_OBSRADARRADIALVELOCITYTLAD_INTERFACE_H_

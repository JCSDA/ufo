...
subroutine ufo_insitutemperature_locateobs_c(c_key_self, c_obsspace, c_t1, c_t2, c_locs) bind(c,name='ufo_insitutemperature_locateobs_f90')
...
character(len=*), parameter :: myname_="ufo_insitutemperature_locateobs_c"

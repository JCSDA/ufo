...
subroutine ufo_radiance_settraj_c(c_key_self, c_key_geovals) bind(c,name='ufo_radiance_settraj_f90')
...
character(len=*), parameter :: myname_="ufo_radiance_settraj_c"

call ufo_radiance_registry%get(c_key_self, self)
call ufo_geovals_registry%get(c_key_geovals,geovals)

call ufo_radiance_settraj(self, geovals)

end subroutine ufo_radiance_settraj_c

! ------------------------------------------------------------------------------

subroutine ufo_radiance_eqv_tl_c(c_key_self, c_key_geovals, c_key_obsspace, c_key_hofx) bind(c,name='ufo_radiance_eqv_tl_f90')
...
character(len=*), parameter :: myname_="ufo_radiance_eqv_tl_c"
...
call ufo_radiance_eqv_tl(self, geovals, hofx, obss)

end subroutine ufo_radiance_eqv_tl_c

! ------------------------------------------------------------------------------

subroutine ufo_radiance_eqv_ad_c(c_key_self, c_key_geovals, c_key_obsspace, c_key_hofx) bind(c,name='ufo_radiance_eqv_ad_f90')
...
character(len=*), parameter :: myname_="ufo_radiance_eqv_ad_c"
...
call ufo_radiance_eqv_ad(self, geovals, hofx, obss)

end subroutine ufo_radiance_eqv_ad_c

! ------------------------------------------------------------------------------

subroutine ufo_obs_get(c_key_self, lcol, c_col, c_key_ovec) bind(c,name='ufo_obsdb_radiance_get_f90')  

! (C) Copyright 2008-2021 NOAA NWS NCEP EMC
...
!$$$ end documentation block
 ...
 ! use JEDI kind_real, but rename to `r_kind` to minimize code changes from GSI
 use kinds, only : r_kind => kind_real
 ...
 ! GSI constant that is not in ufo_constants_mod
 real(r_kind), parameter :: one_tenth = 0.1_r_kind
...
!$$$
 ...
 use ufo_constants_mod, only : pi, one, two, half, zero
...
!$$$
 ...
 use ufo_constants_mod, only : half, two, deg2rad, rad2deg, zero
...
!$$$
 ...
 use ufo_constants_mod, only : one, rad2deg
...
!$$$
 ...
 use ufo_constants_mod, only : one, half, two, zero, deg2rad, rad2deg, pi
